...
export default class LinkEditing extends Plugin {
	...
	init() {
		...
		editor.model.schema.extend( '$text', { allowAttributes: 'linkId' } );
		...
		editor.conversion.for( 'upcast' )
			...
			.elementToAttribute({
				model: { key: 'linkId', value: viewElement => viewElement.getAttribute( 'id' ) },
				view: { name: 'a', attributes: { id: true } }
			})
			.elementToAttribute( {
				model: { key: 'linkAlt', value: viewElement => viewElement.getAttribute( 'alt' ) },
				view: { name: 'a', attributes: { alt: true } },
			});
		...
		twoStepCaretMovementPlugin.registerAttribute( 'linkId' );
		twoStepCaretMovementPlugin.registerAttribute( 'linkAlt' );
